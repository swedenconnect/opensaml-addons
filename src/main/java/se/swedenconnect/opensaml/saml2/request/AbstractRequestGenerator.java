...
public abstract class AbstractRequestGenerator<T extends RequestAbstractType, I extends RequestGeneratorInput> implements
    RequestGenerator<T, I>, InitializableComponent {
   ...
   *          the entityID
   */
  public AbstractRequestGenerator(final String entityID) {
  ...
  public void initialize() throws ComponentInitializationException {
    if (StringUtils.isBlank(this.name)) {
      throw new ComponentInitializationException("Property 'name' must be assigned");
    }
